                                            ...
                                            <div className="d-flex justify-content-between">
                                                ...
                                                <div className="dropdown dropdown-primary">
                                                    ...
                                                    <div
                                                        ...
                                                        style={{ right: '0' }}
                                                    >
                                                        <Link className="dropdown-item text-dark mb-1" to="#">
                                            ...
                                            <div className="card-body p-0 pt-3">
                                                ...
                                                <ul className="mb-0 list-unstyled mt-2">
                                                    <li className="mt-1 ms-0">
                                                        <span className="text-muted me-2">Gender:</span>{item.gender}
                                                    </li>
                                                    <li className="mt-1 ms-0">
                                                        <span className="text-muted me-2">Age:</span>{item.Age}
                                                    </li>
                                                    <li className="mt-1 ms-0">
                                                        <span className="text-muted me-2">Country:</span>{item.country}
                                                    </li>
                                                    <li className="mt-1 ms-0">
                                                        <Link to='/patient-ailments'>
                                                        <span className="text-muted me-2">Diagnosis:</span>{item.Diagnosis}
                                                        </Link>  </li>
                                                </ul>
                                            </div>
                                        </div>
