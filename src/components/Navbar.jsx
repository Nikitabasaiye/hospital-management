...
import image from "../assets/images/svg/mobile-app.svg";


import { FiFacebook,FiSearch,FiSettings  ,FiShoppingCart,FiTwitter   } from "react-icons/fi";
            ...
            <div className="offcanvas-footer p-4 border-top text-center">
              <ul className="list-unstyled social-icon social mb-0">
                <li className="list-inline-item mb-0">
                  ...
                  <Link
                    to="https://1.envato.market/shreethemes-portfolio"
                    target="_blank"
                    className="rounded"
                  >
                ...
                <li className="list-inline-item mb-0">
                  ...
                  >
                    ...
                    <TfiDribbble  className="align-middle mb-0" />
                  </Link>
                </li>
                <li className="list-inline-item mb-0">
                ...
                <li className="list-inline-item mb-0">
                  ...
                  >
                    ...
                    <FiFacebook className="align-middle mb-0" />
                  </Link>
                </li>
                <li className="list-inline-item mb-0">
                  ...
                  >
                    ...
                    <FaInstagram className="align-middle mb-0" />
                  </Link>
                </li>
                <li className="list-inline-item mb-0">
        ...
        >
          <ul className={manuClass}>
            ...
            >
              ...
              <ul className="submenu">
                ...
                >
                  ...
                  <ul className="submenu">
                    <li className={manu === "doctor-dashboard" ? "active" : ""}>
                ...
                <li className={manu === "doctor-team" ? "active" : ""}>
                 
                  <Link to="/doctor-team" className="sub-menu-item">
            ...
            >
              ...
              <span className="menu-arrow"></span>
              <ul className="submenu">
                <li className={manu === "pharmacy" ? "active" : ""}>
                 
                  <Link to="/pharmacy" className="sub-menu-item">
                   
                    Pharmacy
                  </Link>
                </li>
                <li className={manu === "pharmacy-shop" ? "active" : ""}>
                 
                  <Link to="/pharmacy-shop" className="sub-menu-item">
                   
                    Shop
                  </Link>
                </li>
                <li
                  className={manu === "pharmacy-product-detail" ? "active" : ""}
                >
                 
                  <Link to="/pharmacy-product-detail" className="sub-menu-item">
                   
                    Medicine Detail
                  </Link>
                </li>
                <li className={manu === "pharmacy-shop-cart" ? "active" : ""}>
                 
                  <Link to="/pharmacy-shop-cart" className="sub-menu-item">
                   
                    Shop Cart
                  </Link>
                </li>
                <li className={manu === "pharmacy-checkout" ? "active" : ""}>
                 
                  <Link to="/pharmacy-checkout" className="sub-menu-item">
                   
                    Checkout
                  </Link>
                </li>
                <li className={manu === "pharmacy-account" ? "active" : ""}>
                 
                  <Link to="/pharmacy-account" className="sub-menu-item">
